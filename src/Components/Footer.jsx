...
const Footer = () => {
  return (
    <footer className="bg-[#100E20] w-full h-full text-white py-16 pt-44 pb-8 relative overflow-hidden">
      <div className="absolute w-full h-full left-[45%] right-0 top-12">
