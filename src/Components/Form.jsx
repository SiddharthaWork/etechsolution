...
const Form = () => {
  return (
    <div className="w-full min-h-[717px] bg-[#8D8D8D]/10 pt-12">
      {/* Heading Section */}
      ...
      <div className="flex flex-col lg:flex-row justify-center max-w-[1380px] mx-auto mt-6 rounded-xl">
        {/* Left Section */}
        <div className="bg-[#2B2B2B] text-white lg:w-[35rem] w-full py-8 px-6 lg:px-8 space-y-8 flex flex-col justify-start items-start rounded-t-xl lg:rounded-tr-none lg:rounded-l-xl">
